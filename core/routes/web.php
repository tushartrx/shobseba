...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => 'permissions:Ecommerce'], function () {
            ...
            //------------ Courier SETTING ------------
            Route::get('/setting/courier', 'Back\PaymentSettingController@courier')->name('back.setting.courier');
            Route::post('/setting/courier/update', 'Back\PaymentSettingController@courier_update')->name('back.setting.courier.update');
        });
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::prefix('user')->group(function () {
            ...
            Route::post('/order/courier/update', 'User\OrderController@order_courier_update')->name('user.order.courier.update');
            //------------ WISHLIST ------------
